...
# Using sensor_id we can change the camera pin accordingly
# Defaults to 1280x720 @ 60fps 
# Flip the image by setting the flip_method (most common values: 0 and 2)
# display_width and display_height determine the size of the window on the screen
# Original: 640, 360: display

def gstreamer_pipeline (sensor_id=0, capture_width=640, capture_height=360, display_width=640, display_height=360, framerate=60, flip_method=0) :   
...
def show_camera():
    ...
    # You can pass the sensor_id in the VideoCapture to connect to the camera accordingly in the jetson
